<template>
	<div class="edit-dataset-request card-wrapper">
		<div class="info">
			<div>
...
export default {
	...
	methods: {
		async adminDecision (bool) {
			await DatasetService.adminEditDSRequestResponse(this.request.id, {"is_approved": bool}).then((response) => {
